...
/**
 * User-settable event-channel connection policy.
 ...
 * the battery-respectful default is WorkManager.
 */
class ConnectionSettings(context: Context) {
    ...
    /**
     * The Maker's declared availability ( 3b): "available" | "busy" | "dnd".
    ...
    /** How many Alerts/Info items the Maker has already seen ( — the unread badge
